...
def load_config(env_file: str | None = None) -> Config:
    ...
    return Config(
        ...
        worksheet_1=WorksheetConfig(sheet_id=worksheet_1_id, slug="worksheet_1", label="Worksheet 1"),
        worksheet_2=WorksheetConfig(sheet_id=worksheet_2_id, slug="worksheet_2", label="Worksheet 2"),
